...
export const GitHubPanel = () => {
	...
	return (
		<div className="w-full mt-10 gap-5 md:gap-10 md:px-10">
			...
			<div className="w-85 h-64 border-gray-300 border-2 overflow-auto md:p-2">
				<table className="min-w-max table-fixed md:table-auto text-left rtl:text-right text-gray-500 ">
